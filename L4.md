...
Gracias a la implementación mostrada, se logra generar primero una grafica que muestra el comportamiento del proceso estocástico W(t) a través del tiempo para un número de 100 realizaciones, donde además se muestra el valor esperado de las 100 realizaciones y el valor esperado teórico del proceso aleatorio W(t). Si bien, en cada implementación se generan gráficas distintas de forma aleatoria para W(t), a continuación se muestra una de ellas: 
![Figura 1](Figura%201.png)

se logran generar gráficas aleatorias que muestran 
